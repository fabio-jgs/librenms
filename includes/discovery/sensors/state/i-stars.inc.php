 ...
 * @author     Fabio Meincehim <fabio.jgs@gmail.com>
 */

$ups_state_oid = '.1.3.6.1.2.1.33.1.4.1.0';
$ups_state = snmp_get($device, $ups_state_oid, '-Oqv');

if (!empty($ups_state) || $ups_state == 0) {
    // UPS state OID (Value : 0-1 Unknown, 2 XXXX, 3 On Line, 4 XXX, 5 On Battery, 6 On Bypass, 7 Rebooting, 8 Standby, 9 On Buck )
    $state_name = 'i-stars';
    ...
    if ($state_index_id !== null) {
        $states = array(
            ...
            array($state_index_id,'OnBattery',0,5,1) ,
